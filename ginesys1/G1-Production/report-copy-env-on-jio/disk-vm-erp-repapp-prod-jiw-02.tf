...
resource "azurerm_managed_disk" "app-disk-02" {
  create_option                     = "Import"
  hyper_v_generation                = "V2"
  image_reference_id                = ""
  location                          = "jioindiawest"
  name                              = "disk-os_vm-erp-repapp-prod-jiw-02"
  ...
  source_uri                        = "https://storageerpreportlogging.blob.core.windows.net/transfer/temp_snap_disk-os_vm-erp-repapp-prod-01.vhd"
